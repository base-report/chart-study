...
<nav
	class={`${
		isActive ? 'bg-indigo-200 dark:bg-gray-900' : 'bg-indigo-50 dark:bg-gray-800'
	}  relative z-20 drop-shadow `}
>
	<div class="mx-auto w-full px-2">
		<div class="flex h-8 items-center gap-2">
			...
			{#if !$onePaneLeft}
				<button
					type="button"
					class="font-medium text-gray-700 hover:text-gray-900 dark:text-gray-400  dark:hover:text-gray-200 "
					title="Remove pane"
